...
Proof.
  ...
  Case "WHILE".
    assert (bequiv b (fold_constants_bexp b)) as Heb. apply fold_constants_bexp_sound.
    destruct (fold_constants_bexp b) eqn:Hfb.
      apply WHILE_true. apply Heb.
      unfold cequiv. split; intros;
        inversion H; subst.
          apply E_Skip.
          rewrite (Heb st) in H2. inversion H2.
          apply E_WhileEnd. apply (Heb st').
      apply CWhile_congruence. apply Heb. apply IHc.
      apply CWhile_congruence. apply Heb. apply IHc.
      apply CWhile_congruence. apply Heb. apply IHc.
      apply CWhile_congruence. apply Heb. apply IHc.
Qed.
